...
// mongo db의 데몬인 mongod를 실행해야한다.		+var app = express.createServer(express.logger());
//var mongoose = require('mongoose');		
 		 
// mongoose를 사용하는 이유는 스키마를 사용하기 위함이다.		+app.get('/', function(request, response) {
//var MemoSchema = mongoose.Schema({ username: String, memo: String });		+  response.send('Hello World!');
